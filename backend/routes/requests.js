...
// Hide all requests for the logged-in user (soft hide, not delete)
router.patch('/hide-all', authorize('Developer', 'Reviewer', 'HOD', 'DTG', 'CDT', 'HostingTeam'), hideAllRequestsForUser);
