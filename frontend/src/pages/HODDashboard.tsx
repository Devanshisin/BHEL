...
import { Building2, CheckCircle, XCircle, Clock, LogOut, Trash2 } from 'lucide-react';
  ...
  const handleClearAllRequests = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setRecentSubmissions([]);
        // Optionally refetch requests to confirm
        // fetchRequests();
      } else {
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-medium text-gray-700">Reviewer Note</th>
              ...
              <tbody>
                {requests.map((request) => (
                  <tr key={request._id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-gray-600">{request.workflow.reviewer.comment || '-'}</td>
