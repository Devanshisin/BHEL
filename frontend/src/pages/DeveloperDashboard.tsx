...
export const DeveloperDashboard: React.FC = () => {
  ...
  // Clear all requests (from view, not delete from backend)
  const handleClearAllRequests = async () => {
    if (!window.confirm('Are you sure you want to clear ALL your requests from view? You can still see them on other dashboards.')) return;
    try {
      const token = localStorage.getItem('token');
        ...
        <div className="mt-8">
          <Card>
            <div className="flex items-center justify-between mb-6">
              ...
              <Button onClick={handleClearAllRequests} variant="danger" size="sm" icon={Trash2}>
                Clear All
              </Button>
            </div>
